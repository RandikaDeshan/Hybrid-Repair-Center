  ...
  return (
    <div className=" w-full h-screen relative">
      <div className=" w-full h-full flex flex-col justify-center items-center space-y-5 px-10 absolute z-10 bg-black/50">
        <p className=" text-white text-7xl text-center font-bold font-['Poppins'] leading-23 text-shadow-2xs text-shadow-black">
            Hybrid Vehicle Service, Repair & Paint Centre

        </p>
        <p className=" text-green-400 text-2xl font-['Inter'] text-center font-semibold text-shadow-2xs pb-10">
