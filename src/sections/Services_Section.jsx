...
const Services_Section = () => {
  ...
  return (
    <div className=" w-full h-full px-10 mt-20 flex flex-col items-center">
      <div
        data-aos="zoom-in-up"
      ...
      <div
        data-aos="zoom-in-up"
        data-aos-duration="2000"
        className=' w-full h-100 mb-20 mt-30 flex justify-between font-["Inter"]'
      >
        <div className=" w-1/2 h-full">
          ...
          <Link
            ...
            className="inline-block mt-10 px-8 py-3 bg-white border border-green-600 text-green-600 font-bold rounded-2xl hover:bg-green-400 hover:text-white transition-all duration-300"
          >
            Learn More
          </Link>
        </div>
      ...
      <div
        data-aos="zoom-in-up"
        data-aos-duration="2000"
        className=' w-full h-100 my-20 flex justify-between font-["Inter"]'
      >
        <div className=" w-1/2 h-full rounded-lg overflow-hidden">
          <img
            src={ServicesImg2}
