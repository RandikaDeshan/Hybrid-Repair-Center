    ...
    <div className=" w-full h-full flex flex-col items-center overflow-hidden">
      <div className=" relative w-full h-screen">
        <div className=" absolute z-10 bg-black/50 w-full h-full flex flex-col justify-center items-center">
          ...
          >
            <div className=" w-full flex px-5 md:px-10 space-x-3 md:space-x-10 justify-center items-center">
      ...
      <div className=' w-full h-full px-5 md:px-10 flex flex-col items-center py-20 font-["Inter"]'>
        ...
        >
          From minor scratches to complete accident repairs, our body repair and
          painting team delivers factory-quality workmanship with accurate
          colour matching and durable finishes.
        </p>
        <p
          data-aos="zoom-in-up"
          data-aos-duration="2000"
        ...
        <p
          data-aos="zoom-in-up"
          data-aos-duration="2000"
          className=" text-xl md:text-3xl font-bold pb-20 pt-30"
        >
          Why Choose Us
        </p>
        <div
