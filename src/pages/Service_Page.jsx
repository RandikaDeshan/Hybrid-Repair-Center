...
import { MdEmail, MdLocalCarWash, MdLocationOn } from "react-icons/md";
import Aos from "aos";
      ...
      <div className=' w-full h-full px-10 flex flex-col items-center py-20 font-["Inter"]'>
        ...
        <div className=" w-full grid grid-cols-3 gap-8">
          {services.map((service) => (
            <div data-aos="zoom-in-up" data-aos-duration="2000" className=" w-full h-50 rounded-2xl space-y-5 bg-green-300 drop-shadow-xl drop-shadow-black/50 flex flex-col p-5 justify-center items-center">
        ...
        <div data-aos="zoom-in-up" data-aos-duration="2000" className=" w-100 h-full rounded-2xl drop-shadow-xl bg-white drop-shadow-gray-400 border p-10 border-green-500 flex flex-col items-center">
            <div className=" flex flex-col space-y-5">
                <div className=" flex space-x-3 items-center">
                    <TiTick size={30} className=" text-green-600"/>
                    <p className=" font-semibold font-['Inter'] text-lg">Qualified Technicians</p>
                </div>
                <div className=" flex space-x-3 items-center">
                    <TiTick size={30} className=" text-green-600"/>
                    <p className=" font-semibold font-['Inter'] text-lg">Genuine Quality Parts</p>
                </div>
                <div className=" flex space-x-3 items-center">
                    <TiTick size={30} className=" text-green-600"/>
                    <p className=" font-semibold font-['Inter'] text-lg">Modern Diagnostic Equipment</p>
                </div>
                <div className=" flex space-x-3 items-center">
                    <TiTick size={30} className=" text-green-600"/>
                    <p className=" font-semibold font-['Inter'] text-lg">Fast Turnaround</p>
                </div>
                <div className=" flex space-x-3 items-center">
                    <TiTick size={30} className=" text-green-600"/>
                    <p className=" font-semibold font-['Inter'] text-lg">Affordable Pricing</p>
                </div>
            </div>
        </div>
        <div data-aos="zoom-in-up" data-aos-duration="2000" className=" w-full h-170 flex mt-20">
            <div className=" flex flex-col w-1/3 h-full rounded-l-2xl overflow-hidden mr-1">
                <div className=" w-full h-1/2 overflow-hidden mb-1">
                    <img src={ServicesImg2} alt="" className=" w-full h-full object-cover rounded-tl-2xl hover:scale-105 transition-transform duration-300"/>
                </div>
                <div className=" w-full h-1/2 overflow-hidden mt-1">
                    <img src={ServicesImg3} alt="" className=" w-full h-full object-cover rounded-bl-2xl hover:scale-105 transition-transform duration-300"/>
                </div>
            </div>
            <div className=" flex flex-col w-1/3 h-full overflow-hidden mx-1">
                <div className=" w-full h-1/2 overflow-hidden mb-1">
                    <img src={ServicesImg4} alt="" className=" w-full h-full object-cover hover:scale-105 transition-transform duration-300"/>
                </div>
                <div className=" w-full h-1/2 overflow-hidden mt-1">
                    <img src={ServicesImg5} alt="" className=" w-full h-full object-cover hover:scale-105 transition-transform duration-300"/>
                </div>
            </div>
            <div className=" flex flex-col w-1/3 h-full rounded-r-2xl overflow-hidden ml-1">
                <div className=" w-full h-1/2 overflow-hidden mb-1">
                    <img src={ServicesImg6} alt="" className=" w-full h-full object-cover rounded-tr-2xl hover:scale-105 transition-transform duration-300"/>
                </div>
                <div className=" w-full h-1/2 overflow-hidden mt-1">
                    <img src={ServicesImg7} alt="" className=" w-full h-full object-cover rounded-br-2xl hover:scale-105 transition-transform duration-300"/>
                </div>
            </div>
        </div>
        <div className=" mt-20 flex w-full space-x-20 justify-center">
            <div data-aos="zoom-in-up" data-aos-duration="2000" className="flex space-x-5">
